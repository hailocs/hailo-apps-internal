...
askQuestions:
  header: "Choice"
  question: "What should the VLM look for?"
  options:
    - label: "Activities (sleeping, eating, playing)"
...
- `.github/skills/hl-build-vlm-app/SKILL.md` — VLM skill with complete code templates, imports, and patterns
...
- `.github/memory/gen_ai_patterns.md` — VLM multiprocessing backend, prompt format, token streaming

**Read if the task involves custom Backend integration**:
- `.github/toolsets/vlm-backend-api.md` — Backend class API (constructor, methods, thread safety)
