...
```bash
python3 .github/scripts/validate_app.py hailo_apps/python/gen_ai_apps/my_voice_app --smoke-test
```
...
```bash
python3 .github/scripts/validate_app.py hailo_apps/python/standalone_apps/my_speech_app --smoke-test
```
