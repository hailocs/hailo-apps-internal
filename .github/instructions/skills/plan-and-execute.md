...
runSubagent:
  ...
  prompt: |
    ...
    - .github/memory/gen_ai_patterns.md       ← for Gen AI apps
    - .github/memory/pipeline_optimization.md  ← for GStreamer apps
    - .github/memory/camera_and_display.md     ← for camera apps
    - .github/memory/hailo_platform_api.md     ← for direct HailoRT
    
    SKILL (pick one):
    - .github/instructions/skills/<relevant_skill>.md
...
IF gate fails:
  ...
  2. Check .github/memory/common_pitfalls.md
