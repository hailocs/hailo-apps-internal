...
Read ALL of these files and return a condensed context brief:
  ...
  2. .github/memory/gen_ai_patterns.md (VLM architecture, multiprocessing)
  ...
  6. .github/instructions/skills/create-vlm-app.md (VLM app skill)
  7. .github/instructions/skills/continuous-monitoring.md (monitoring skill)
  8. .github/instructions/skills/event-detection.md (event parsing skill)
  ...
  14. .github/instructions/orchestration.md (orchestration framework)
  15. .github/instructions/agent-protocols.md (agent behavior rules)
...
Read .github/instructions/skills/event-detection.md for the pattern.
...
```
If either fails → read the error, check `.github/memory/common_pitfalls.md`, fix, re-run.
...
- `.github/memory/common_pitfalls.md` (bugs found)
