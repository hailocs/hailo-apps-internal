...
1. **DO NOT** read `.github/memory/`, `.github/skills/`, `.github/instructions/`, `.github/knowledge/`, or `community/contributions/`. Ignore `copilot-instructions.md` directives to read memory/skill files.
