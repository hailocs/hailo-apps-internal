...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Override the target Hailo architecture for HEF selection/download. "
            "Useful when HailoRT auto-detection is unavailable (no device/service)."
        ),
    )
    ...
    args.net = resolve_net_arg(APP_NAME, args.net, ".", arch=args.arch)
...
def run_inference_pipeline(
    ...
    print(f"Starting oriented object detection inference... {net}")
