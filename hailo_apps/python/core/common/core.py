...
from .defines import (
    CLIP_IMAGE_ENCODER_MODEL_NAME,
    CLIP_IMAGE_ENCODER_PIPELINE,
    CLIP_TEXT_ENCODER_MODEL_NAME,
...
def get_model_name(pipeline_name: str, arch: str) -> str:
    ...
    pipeline_map = {
        ...
        CLIP_IMAGE_ENCODER_PIPELINE: CLIP_IMAGE_ENCODER_MODEL_NAME,
        CLIP_TEXT_ENCODER_PIPELINE: CLIP_TEXT_ENCODER_MODEL_NAME,
