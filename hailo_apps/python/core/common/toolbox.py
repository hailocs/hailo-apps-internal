...
try:
    ...
    from hailo_apps.python.core.common.camera_utils import is_stream_url, open_rpi_camera, open_usb_camera, CapProcessingMode
    ...
    from .camera_utils import is_stream_url, open_rpi_camera, open_usb_camera, CapProcessingMode
