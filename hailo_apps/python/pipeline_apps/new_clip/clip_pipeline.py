...
from hailo_apps.python.core.common.defines import (
    ...
    CLIP_CUSTOM_POSTPROCESS_FUNCTION_NAME,
...
from hailo_apps.python.pipeline_apps.new_clip.text_image_matcher import text_image_matcher
from hailo_apps.python.pipeline_apps.new_clip import gui
# endregion
...
class GStreamerClipApp(GStreamerApp):
    def __init__(self, app_callback, user_data, parser=None):
        ...
        self.hef_path_clip = get_resource_path(pipeline_name=CLIP_IMAGE_ENCODER_PIPELINE, resource_type=RESOURCES_MODELS_DIR_NAME)
        ...
        self.clip_post_process_function_name = CLIP_CUSTOM_POSTPROCESS_FUNCTION_NAME
