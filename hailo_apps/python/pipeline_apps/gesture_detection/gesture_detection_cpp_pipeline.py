...
Usage:
    python -m hailo_apps.python.pipeline_apps.gesture_detection.gesture_detection_cpp_pipeline
    python -m hailo_apps.python.pipeline_apps.gesture_detection.gesture_detection_cpp_pipeline --input /dev/video0
"""
...
# Post-process shared libraries (installed to /usr/local/hailo/resources/so/)
