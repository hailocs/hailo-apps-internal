...
1. `.hailo/skills/hl-build-pipeline-app.md` — Pipeline app skill (includes Frame Overlay, Detection Data Extraction, Reusing Pipeline Classes sections)
2. `.hailo/toolsets/pose-keypoints.md` — COCO keypoint indices, skeleton connections, coordinate transform
3. `.hailo/toolsets/core-framework-api.md` — Framework API (buffer_utils, get_pipeline_parser)
4. `.hailo/memory/common_pitfalls.md` — RGB→BGR for set_frame(), OpenCV patterns
