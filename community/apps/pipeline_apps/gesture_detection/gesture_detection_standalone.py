...
Usage:
    ...
    python -m community.apps.pipeline_apps.gesture_detection.gesture_detection_standalone --input video.mp4
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Gesture Detection (Hailo, MediaPipe Blaze)")
    parser.add_argument("--input", type=str, default=None,
                        help="Video source: camera index (0) or video file path")
    parser.add_argument("--palm-model", type=str, default=None,
