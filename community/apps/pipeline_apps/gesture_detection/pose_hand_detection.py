...
Usage:
    ...
    python -m community.apps.pipeline_apps.gesture_detection.pose_hand_detection --input video.mp4
"""
...
# C++ postprocess shared libraries (gesture-specific, resolved at runtime)
