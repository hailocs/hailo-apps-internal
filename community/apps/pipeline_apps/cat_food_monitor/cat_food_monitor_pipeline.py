...
class GStreamerCatFoodMonitorApp(GStreamerApp):
    def __init__(self, app_callback, user_data, parser=None):
        ...
        # Use default video or user-specified source
    ...
    def get_pipeline_string(self):
        ...
        mobile_facenet_pipeline = INFERENCE_PIPELINE(
            ...
            batch_size=self.batch_size,
            config_json=None,
            name='cat_recognition_inference',
        )
    ...
    def run_training(self):
        ...
        generate embeddings for each image, and store them in the database.
        ...
        if not os.listdir(self.train_images_dir):
            print(
                ...
                f"Copying default training images from local resources."
            )
        ...
        for cat_name in os.listdir(self.train_images_dir):
            ...
            for image_file in os.listdir(cat_folder):
                ...
                self.current_file = os.path.join(cat_folder, image_file)
                self.create_pipeline()
                self.connect_train_vector_db_callback()
                try:
