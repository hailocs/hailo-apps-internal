#!/bin/bash
# Build and install the vampire_mirror GStreamer overlay element
# (hailovampire_overlay) into the system GStreamer plugin directory.
#
# Usage:
...
echo "=== Building vampire_mirror overlay element (hailovampire_overlay) ==="
...
if [ "${1:-}" != "--no-install" ]; then
    ...
    echo "Install complete. Verify with: gst-inspect-1.0 hailovampire_overlay"
else
    echo ""
