...
# -----------------------------------------------------------------------------------------------
# Crowd Counting GStreamer Application
# -----------------------------------------------------------------------------------------------

APP_TITLE = "hailo-crowd-counting"


class GStreamerCrowdCountingApp(GStreamerApp):
    def __init__(self, app_callback, user_data, parser=None):
        ...
        hailo_logger.info("Initializing GStreamer Crowd Counting App...")
        ...
        # Store the line-y position for the callback to access
        self.line_y = self.options_menu.line_y
