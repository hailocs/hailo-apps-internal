...
| `hailo-lpr`           | [License Plate Recognition](../../hailo_apps/python/pipeline_apps/lpr/README.md)               | Real-time license plate detection and OCR recognition using a three-stage pipeline (vehicle detection, LP detection, OCR). This application is currently in BETA. |
