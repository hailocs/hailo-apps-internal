...
| `hailo-tiling`    | [Tiling](../../hailo_apps/hailo_app_python/apps/tiling/README.md)        | Single & multi scale tiling splitting each frame into several tiles which are processed independently - effective for detecting small objects in high-resolution frames. This application is currently in BETA.
